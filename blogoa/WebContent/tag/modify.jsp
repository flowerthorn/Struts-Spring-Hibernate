...
<s:textfield name="tm.tno" label="标签编号" value="%{tm.tno}"  readonly="true" cssStyle="background:#B5B5B5"/>
<s:textfield name="tm.tname" label="标签名称" value="%{tm.tname}" required="true"  />
<s:submit value="修改"/>
</s:form>
</div>
</body>
